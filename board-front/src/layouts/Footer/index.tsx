...
const onNaverButtonClickHandler = ()=>{
    window.open('https://www.naver.com')
}
// component: Footer layouts 랜더링 //
    return (
        <div id='footer'>
            <div className='footer-container'>
                <div className='footer-top'>
                    ...
                    <div className='footer-link-box'>
                        ...
                        <div className='icon-button'>
                            <div className='icon naver-blog-icon' onClick={onNaverButtonClickHandler}></div>
                        </div>
                    </div>
                </div>
